...
def get_args_parser():
    ...
    parser.add_argument('--lr_drop', default=100, type=int) #40
    parser.add_argument('--save_period', default=50, type=int)
    parser.add_argument('--lr_drop_epochs', default=None, type=int, nargs='+')
    parser.add_argument('--clip_max_norm', default=0.1, type=float,
                        help='gradient clipping max norm')

    parser.add_argument('--meta_arch', default='TransDETR_ignored', type=str)

    parser.add_argument('--sgd', action='store_true')

    # Variants of Deformable DETR
    parser.add_argument('--with_box_refine', default=True, action='store_true') #default=False, 
    ...
    parser.add_argument('--dropout', default=0, type=float, # 0.1
    ...
    parser.add_argument('--extra_track_attn',default=True, action='store_true')
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='Text')
    ...
    parser.add_argument('--output_dir', default='/data/cmpe258-sp24/jingshu/Data/app_processed_video',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='/data/cmpe258-sp24/jingshu/exps/e2e_TransVTS_r50_ICDAR15_eval/TextSpottingMOTA60.9IDF172.8.pth', help='resume from checkpoint')
    ...
    parser.add_argument('--data_txt_path_train',
                        default= './tools/gen_labels/datasets/data_path/ICDAR15.train', type=str, #'./datasets/data_path/detmot17.train'
    ...
    parser.add_argument('--query_interaction_layer', default='QIM', type=str,
                        help="")
    parser.add_argument('--sample_mode', type=str, default='random_interval') #fixed_interval
    parser.add_argument('--sample_interval', type=int, default=3) #1
    parser.add_argument('--random_drop', type=float, default=0.1) #0
    parser.add_argument('--fp_ratio', type=float, default=0.3) #0
    parser.add_argument('--merger_dropout', type=float, default=0) #0.1
    parser.add_argument('--update_query_pos', default=True, action='store_true')

    parser.add_argument('--sampler_steps', type=int, nargs='*', default=[50,90,120])
    parser.add_argument('--sampler_lengths', type=int, nargs='*', default=[2, 3, 4, 5],
                    help='Specify the lengths for the sampler')
